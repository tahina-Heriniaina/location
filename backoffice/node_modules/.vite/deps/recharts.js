...
import { castDraft, combineReducers, configureStore, createAction, createListenerMiddleware, createSelector, createSlice, current } from "./redux-toolkit.modern-CSFUccPO.js";
import { require_react } from "./react-DBPeC59m.js";
import { require_react_dom } from "./react-dom-DxJvBwSQ.js";
import { Provider_default } from "./react-redux-C9T3b5ld.js";
import { clsx } from "./clsx-dO0s959M.js";
...
function findAllByType(children, type) {
	...
	toArray$2(children).forEach((child) => {
		var childType = (0, import_get$6.default)(child, "type.displayName") || (0, import_get$6.default)(child, "type.name");
...
*/
var isValidSpreadableProp = (property$2, key, includeEvents, svgElementType) => {
	var _ref$1;
	...
	*/
	...
	var isSpecificSvgAttribute = typeof property$2 !== "function" && (Boolean(svgElementType) && matchingElementTypeKeys.includes(key) || isSvgElementPropKey(key));
...
function _objectWithoutProperties$36(e, t) {
	if (null == e) return {};
	var o, r, i = _objectWithoutPropertiesLoose$36(e, t);
...
function _objectWithoutPropertiesLoose$36(r, e) {
	if (null == r) return {};
	var t = {};
...
var Surface = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("svg", _extends$46({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ import_react.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("g", _extends$45({ className: layerClass }, filterProps(others, true), { ref }), children);
});
...
var Symbols = (_ref$1) => {
	...
	*/
	var getPath$2 = () => {
		...
		return Symbol$1().type(symbolFactory).size(calculateAreaSize(size, sizeType, realType))();
	};
	var { className, cx, cy } = props;
	var filteredProps = filterProps(props, true);
	if (cx === +cx && cy === +cy && size === +size) return /* @__PURE__ */ import_react.createElement("path", _extends$44({}, filteredProps, {
	...
	*/
	renderItems() {
		...
		return payload.map((entry, i) => {
			...
			return /* @__PURE__ */ import_react.createElement("li", _extends$43({
				className,
				style: itemStyle,
...
var require_property = /* @__PURE__ */ __commonJS({ "node_modules/es-toolkit/dist/compat/object/property.js": ((exports) => {
	...
	function property$1(path$1) {
		return function(object) {
			return get$8.get(object, path$1);
		};
	}
...
var require_matchesProperty = /* @__PURE__ */ __commonJS({ "node_modules/es-toolkit/dist/compat/predicate/matchesProperty.js": ((exports) => {
	...
	function matchesProperty$1(property$2, source) {
		...
		return function(target) {
			const result = get$7.get(target, property$2);
			if (result === void 0) return has$1.has(target, property$2);
...
var require_use_sync_external_store_shim_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js": ((exports) => {
	(function() {
		...
		var React = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState$19 = React.useState, useEffect$27 = React.useEffect, useLayoutEffect$1 = React.useLayoutEffect, useDebugValue = React.useDebugValue, didWarnOld18Alpha = !1, didWarnUncachedGetSnapshot = !1, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js": ((exports) => {
	(function() {
		...
		"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
		var React = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef$19 = React.useRef, useEffect$27 = React.useEffect, useMemo$10 = React.useMemo, useDebugValue = React.useDebugValue;
...
function useAppSelector(selector) {
	var context = (0, import_react.useContext)(RechartsReduxContext);
	return (0, import_with_selector.useSyncExternalStoreWithSelector)(context ? context.subscription.addNestedSub : addNestedSubNoop, context ? context.store.getState : noop$3, context ? context.store.getState : noop$3, context ? selector : noop$3, refEquality);
}
...
function getValueByDataKey(obj, dataKey, defaultValue) {
	...
	if (isNumOrStr(dataKey)) return (0, import_get$5.default)(obj, dataKey, defaultValue);
...
function LegendContent(props) {
	...
	var contentProps = _objectSpread$55(_objectSpread$55({}, otherProps), {}, { payload: finalPayload });
...
function getDefaultPosition(style, props, margin, chartWidth, chartHeight, box) {
	...
	return _objectSpread$55(_objectSpread$55({}, hPos), vPos);
}
...
function LegendWrapper(props) {
	...
	var outerStyle = portalFromProps ? wrapperStyle : _objectSpread$55(_objectSpread$55({
		position: "absolute",
	...
	}), /* @__PURE__ */ import_react.createElement(LegendContent, _extends$42({}, props, widthOrHeight, {
		margin,
		chartWidth,
		chartHeight,
		contextPayload
...
_defineProperty$57(Legend, "displayName", "Legend");
_defineProperty$57(Legend, "defaultProps", {
	align: "center",
	iconSize: 14,
	itemSorter: "value",
	layout: "horizontal",
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent$1 = () => {
		if (payload && payload.length) {
			...
			var items = (itemSorter ? (0, import_sortBy$1.default)(payload, itemSorter) : payload).map((entry, i) => {
				...
				var finalItemStyle = _objectSpread$54({
					display: "block",
					paddingTop: 4,
					paddingBottom: 4,
	...
	var finalStyle = _objectSpread$54({
		margin: 0,
		padding: 10,
		backgroundColor: "#fff",
	...
	var finalLabelStyle = _objectSpread$54({ margin: 0 }, labelStyle);
	...
	return /* @__PURE__ */ import_react.createElement("div", _extends$41({
		className: wrapperCN,
		style: finalStyle
...
var TooltipBoundingBox = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty$55(this, "handleKeyDown", (event) => {
			if (event.key === "Escape") {
	...
	render() {
		...
		var positionStyles = hasPortalFromProps ? {} : _objectSpread$53(_objectSpread$53({ transition: isAnimationActive && active ? "transform ".concat(animationDuration, "ms ").concat(animationEasing) : void 0 }, cssProperties), {}, {
			pointerEvents: "none",
		...
		var outerStyle = _objectSpread$53(_objectSpread$53({}, positionStyles), {}, { visibility: !this.state.dismissed && active && hasPayload ? "visible" : "hidden" }, wrapperStyle);
...
var getPath$1 = (_ref$1) => {
	...
	if (Array.isArray(baseLine)) {
		...
		var areaPoints = formatPoints.map((entry, index) => _objectSpread$52(_objectSpread$52({}, entry), {}, { base: formatBaseLine[index] }));
...
var Curve = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$40({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var Cross = (_ref$1) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$39({}, filterProps(props, true), {
...
function resolveDefaultProps(realProps, defaultProps$10) {
	var resolvedProps = _objectSpread$50({}, realProps);
...
*/
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$49(_objectSpread$49({}, res), {}, { [key]: fn(key, obj[key]) }), {});
...
var calStepperVals = (easing, preVals, steps) => {
	var nextStepVals = mapObject((key, val) => {
		if (needContinue(val)) {
			...
			return _objectSpread$48(_objectSpread$48({}, val), {}, {
				from: newX,
				velocity: newV
			});
		}
	...
	if (steps < 1) return mapObject((key, val) => {
		if (needContinue(val)) return _objectSpread$48(_objectSpread$48({}, val), {}, {
...
function createStepperUpdate(from$1, to$1, easing, interKeys, render, timeoutController) {
	var preTime;
	var stepperStyle = interKeys.reduce((res, key) => _objectSpread$48(_objectSpread$48({}, res), {}, { [key]: {
		from: from$1[key],
		velocity: 0,
		to: to$1[key]
	} }), {});
	...
	var stepperUpdate = (now) => {
		...
		render(_objectSpread$48(_objectSpread$48(_objectSpread$48({}, from$1), to$1), getCurrStyle()));
		preTime = now;
...
function createTimingUpdate(from$1, to$1, easing, duration, interKeys, render, timeoutController) {
	var stopAnimation = null;
	var timingStyle = interKeys.reduce((res, key) => _objectSpread$48(_objectSpread$48({}, res), {}, { [key]: [from$1[key], to$1[key]] }), {});
	var beginTime;
	var timingUpdate = (now) => {
		if (!beginTime) beginTime = now;
		var t = (now - beginTime) / duration;
		var currStyle = mapObject((key, val) => alpha(...val, easing(t)), timingStyle);
		render(_objectSpread$48(_objectSpread$48(_objectSpread$48({}, from$1), to$1), currStyle));
		if (t < 1) stopAnimation = timeoutController.setTimeout(timingUpdate);
			...
			render(_objectSpread$48(_objectSpread$48(_objectSpread$48({}, from$1), to$1), finalStyle));
		}
	};
	return () => {
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) return /* @__PURE__ */ import_react.createElement("path", _extends$38({}, filterProps(props, true), {
		className: layerClass,
	...
	return /* @__PURE__ */ import_react.createElement(JavascriptAnimate, {
		...
		return /* @__PURE__ */ import_react.createElement("path", _extends$38({}, filterProps(props, true), {
			className: layerClass,
			d: getRectanglePath(currX, currY, currWidth, currHeight, radius),
			ref: pathRef,
			style: _objectSpread$47(_objectSpread$47({}, animationStyle), props.style)
		}));
	});
};
...
var Sector = (sectorProps) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$37({}, filterProps(props, true), {
		className: layerClass,
		d: path$1
	}));
};
...
function hslConvert(o) {
	...
	o = o.rgb();
	var r = o.r / 255, g = o.g / 255, b = o.b / 255, min$1 = Math.min(r, g, b), max$1 = Math.max(r, g, b), h = NaN, s$1 = max$1 - min$1, l = (max$1 + min$1) / 2;
	if (s$1) {
		if (r === max$1) h = (g - b) / s$1 + (g < b) * 6;
		else if (g === max$1) h = (b - r) / s$1 + 2;
		else h = (r - g) / s$1 + 4;
...
function polymap(domain, range$5, interpolate$1) {
	...
	while (++i < j) {
		...
		r[i] = interpolate$1(range$5[i], range$5[i + 1]);
	}
	return function(x$1) {
...
var selectErrorBarsSettingsExceptStacked = createSelector([
...
var combineNumericalDomain = (axisSettings, domainDefinition, domainOfStackGroups, allDataWithErrorDomains, referenceElementsDomain, layout, axisType) => {
	...
	var mergedDomains = layout === "vertical" && axisType === "xAxis" || layout === "horizontal" && axisType === "yAxis" ? mergeDomains(domainOfStackGroups, referenceElementsDomain, computeNumericalDomain(allDataWithErrorDomains)) : mergeDomains(referenceElementsDomain, computeNumericalDomain(allDataWithErrorDomains));
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
	if (axis == null || scale == null) return;
	return _objectSpread$46(_objectSpread$46({}, axis), {}, { scale });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
	...
	if (hasBeenActivePreviously(appropriateMouseInteraction)) {
		if (activeFromProps) return _objectSpread$45(_objectSpread$45({}, appropriateMouseInteraction), {}, { active: true });
	...
	return _objectSpread$45(_objectSpread$45({}, noInteraction), {}, { coordinate: appropriateMouseInteraction.coordinate });
};
...
var combineTooltipPayload = (tooltipPayloadConfigurations, activeIndex, chartDataState, tooltipAxisDataKey, activeLabel, tooltipPayloadSearcher, tooltipEventType) => {
	...
	return tooltipPayloadConfigurations.reduce((agg, _ref$1) => {
		...
		if (Array.isArray(tooltipPayload)) tooltipPayload.forEach((item) => {
			var newSettings = _objectSpread$44(_objectSpread$44({}, settings), {}, {
				name: item.name,
				unit: item.unit,
				color: void 0,
				fill: void 0
...
var useTooltipAxisBandSize = () => {
	...
	return getBandSizeOfAxis(_objectSpread$43(_objectSpread$43({}, tooltipAxis), {}, { scale: tooltipAxisScale }), tooltipTicks);
};
...
function CursorInternal(props) {
	...
	var cursorProps = _objectSpread$42(_objectSpread$42(_objectSpread$42(_objectSpread$42({
		stroke: "#ccc",
		pointerEvents: "none"
	...
	return /* @__PURE__ */ (0, import_react.isValidElement)(cursor) ? /* @__PURE__ */ (0, import_react.cloneElement)(cursor, cursorProps) : /* @__PURE__ */ (0, import_react.createElement)(cursorComp, cursorProps);
}
function Cursor(props) {
	...
	return /* @__PURE__ */ import_react.createElement(CursorInternal, _extends$36({}, props, {
...
var require_eventemitter3 = /* @__PURE__ */ __commonJS({ "node_modules/eventemitter3/index.js": ((exports, module) => {
	...
	*/
	function addListener(emitter, event, fn, context, once) {
		...
		var listener = new EE(fn, context || emitter, once), evt = prefix$1 ? prefix$1 + event : event;
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate) {
					var _action$payload$coord = action.payload.coordinate, { x: _x, y: _y } = _action$payload$coord, otherCoordinateProps = _objectWithoutProperties$31(_action$payload$coord, _excluded$31);
					var boundedCoordinate = _objectSpread$41(_objectSpread$41(_objectSpread$41({}, otherCoordinateProps), typeof _x === "number" && { x: Math.max(viewBox.x, Math.min(_x, viewBox.x + viewBox.width)) }), typeof _y === "number" && { y: Math.max(viewBox.y, Math.min(_y, viewBox.y + viewBox.height)) });
					var boundedAction = _objectSpread$41(_objectSpread$41({}, action), {}, { payload: _objectSpread$41(_objectSpread$41({}, action.payload), {}, { coordinate: boundedCoordinate }) });
...
function Tooltip(outsideProps) {
	...
	}, renderContent(content, _objectSpread$40(_objectSpread$40({}, props), {}, {
...
var ResponsiveContainer = /* @__PURE__ */ (0, import_react.forwardRef)((_ref$1, ref) => {
	var { aspect, initialDimension = {
		width: -1,
		height: -1
	}, width = "100%", height = "100%", minWidth = 0, minHeight, maxHeight, children, debounce: debounce$4 = 0, id, className, onResize, style = {} } = _ref$1;
	...
	return /* @__PURE__ */ import_react.createElement("div", {
		...
		style: _objectSpread$39(_objectSpread$39({}, style), {}, {
			width,
			height,
			minWidth,
			minHeight,
...
var Text = /* @__PURE__ */ (0, import_react.forwardRef)((_ref5, ref) => {
	var { x: propsX = 0, y: propsY = 0, lineHeight = "1em", capHeight = "0.71em", scaleToFit = false, textAnchor = "start", verticalAnchor = "end", fill = DEFAULT_FILL } = _ref5, props = _objectWithoutProperties$30(_ref5, _excluded$30);
	...
	var { dx, dy, angle, className, breakAll } = props, textProps = _objectWithoutProperties$30(props, _excluded2$14);
	...
	return /* @__PURE__ */ import_react.createElement("text", _extends$35({}, filterProps(textProps, true), {
		ref,
		x: x$1,
		y: y$1,
...
var renderRadialLabel = (labelProps, position$1, label, attrs, viewBox) => {
	...
	return /* @__PURE__ */ import_react.createElement("text", _extends$34({}, attrs, {
...
var getAttrsOfPolarLabel = (viewBox, offset, position$1) => {
	...
	var { x: x$1, y: y$1 } = polarToCartesian(cx, cy, r, midAngle);
	return {
		x: x$1,
		y: y$1,
		textAnchor: "middle",
...
function Label(outerProps) {
	...
	if (/* @__PURE__ */ (0, import_react.isValidElement)(content)) {
		var { labelRef: _ } = propsWithViewBox, propsWithoutLabelRef = _objectWithoutProperties$29(propsWithViewBox, _excluded$29);
	...
	return /* @__PURE__ */ import_react.createElement(Text, _extends$34({
		ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
	...
	if (label === true) return /* @__PURE__ */ import_react.createElement(Label, _extends$34({ key: "label-implicit" }, commonProps));
	if (isNumOrStr(label)) return /* @__PURE__ */ import_react.createElement(Label, _extends$34({
		key: "label-implicit",
		value: label
	}, commonProps));
	if (/* @__PURE__ */ (0, import_react.isValidElement)(label)) {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$34({
			key: "label-implicit",
			content: label
		}, commonProps));
	}
	if (isLabelContentAFunction(label)) return /* @__PURE__ */ import_react.createElement(Label, _extends$34({
		key: "label-implicit",
		content: label
	}, commonProps));
	if (label && typeof label === "object") return /* @__PURE__ */ import_react.createElement(Label, _extends$34({}, label, { key: "label-implicit" }, commonProps));
	return null;
};
...
var require_last$1 = /* @__PURE__ */ __commonJS({ "node_modules/es-toolkit/dist/compat/array/last.js": ((exports) => {
	...
	function last$2(array) {
		...
		return last$1$1.last(toArray.toArray(array));
	}
	exports.last = last$2;
}) });
...
var _excluded$28 = ["valueAccessor"], _excluded2$13 = [
	"dataKey",
	"clockWise",
	"id",
	"textBreakAll"
...
function LabelList(_ref$1) {
	var { valueAccessor = defaultAccessor } = _ref$1, restProps = _objectWithoutProperties$28(_ref$1, _excluded$28);
	var { dataKey, clockWise, id, textBreakAll } = restProps, others = _objectWithoutProperties$28(restProps, _excluded2$13);
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map((entry, index) => {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$33({}, filterProps(entry, true), others, idProps, {
...
function LabelListFromLabelProp(_ref2) {
	...
	if (typeof label === "object") return /* @__PURE__ */ import_react.createElement(LabelList, _extends$33({ key: "labelList-implicit" }, label, { type: String(label.type) }));
	return null;
}

//#endregion
//#region node_modules/recharts/es6/component/Customized.js
var _excluded$27 = ["component"];
...
function Customized(_ref$1) {
	var { component } = _ref$1, props = _objectWithoutProperties$27(_ref$1, _excluded$27);
	var child;
...
var Polygon = (props) => {
	var { points, className, baseLinePoints, connectNulls } = props, others = _objectWithoutProperties$26(props, _excluded$26);
	if (!points || !points.length) return null;
	var layerClass = clsx("recharts-polygon", className);
	if (baseLinePoints && baseLinePoints.length) {
		var hasStroke = others.stroke && others.stroke !== "none";
		var rangePath = getRanglePath(points, baseLinePoints, connectNulls);
		return /* @__PURE__ */ import_react.createElement("g", { className: layerClass }, /* @__PURE__ */ import_react.createElement("path", _extends$32({}, filterProps(others, true), {
			fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
			stroke: "none",
			d: rangePath
		})), hasStroke ? /* @__PURE__ */ import_react.createElement("path", _extends$32({}, filterProps(others, true), {
			fill: "none",
			d: getSinglePolygonPath(points, connectNulls)
		})) : null, hasStroke ? /* @__PURE__ */ import_react.createElement("path", _extends$32({}, filterProps(others, true), {
			fill: "none",
			d: getSinglePolygonPath(baseLinePoints, connectNulls)
		})) : null);
	}
	var singlePath = getSinglePolygonPath(points, connectNulls);
	return /* @__PURE__ */ import_react.createElement("path", _extends$32({}, filterProps(others, true), {
...
var Dot = (props) => {
	...
	if (cx === +cx && cy === +cy && r === +r) return /* @__PURE__ */ import_react.createElement("circle", _extends$31({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var PolarAngles = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("g", { className: "recharts-polar-grid-angle" }, polarAngles.map((entry) => {
		...
		return /* @__PURE__ */ import_react.createElement("line", _extends$30({}, polarAnglesProps, {
...
var ConcentricCircle = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("circle", _extends$30({}, concentricCircleProps, {
...
var ConcentricPolygon = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$30({}, concentricPolygonProps, {
...
var ConcentricGridPath = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("g", { className: "recharts-polar-grid-concentric" }, renderBackground && gridType === "circle" && /* @__PURE__ */ import_react.createElement(ConcentricCircle, _extends$30({}, props, { radius: maxPolarRadius })), renderBackground && gridType !== "circle" && /* @__PURE__ */ import_react.createElement(ConcentricPolygon, _extends$30({}, props, { radius: maxPolarRadius })), polarRadius.map((entry, i) => {
		var key = i;
		if (gridType === "circle") return /* @__PURE__ */ import_react.createElement(ConcentricCircle, _extends$30({ key }, props, {
			fill: "none",
			radius: entry
		}));
		return /* @__PURE__ */ import_react.createElement(ConcentricPolygon, _extends$30({ key }, props, {
			fill: "none",
			radius: entry
		}));
	}));
...
var PolarGrid = (_ref$1) => {
	...
	var { gridType = "polygon", radialLines = true, angleAxisId = 0, radiusAxisId = 0, cx: cxFromOutside, cy: cyFromOutside, innerRadius: innerRadiusFromOutside, outerRadius: outerRadiusFromOutside } = _ref$1, inputs = _objectWithoutProperties$25(_ref$1, _excluded$25);
	...
	return /* @__PURE__ */ import_react.createElement("g", { className: "recharts-polar-grid" }, /* @__PURE__ */ import_react.createElement(ConcentricGridPath, _extends$30({
		gridType,
		radialLines
	}, props, {
		polarAngles,
		polarRadius
	})), /* @__PURE__ */ import_react.createElement(PolarAngles, _extends$30({
		gridType,
		radialLines
	}, props, {
		polarAngles,
...
var renderAxisLine = (props, ticks$1) => {
	var { cx, cy, angle, axisLine } = props, others = _objectWithoutProperties$24(props, _excluded$24);
	...
	var axisLineProps = _objectSpread$35(_objectSpread$35(_objectSpread$35({}, svgPropertiesNoEvents(others)), {}, { fill: "none" }, filterProps(axisLine, false)), {}, {
		x1: point0.x,
		y1: point0.y,
		x2: point1.x,
		y2: point1.y
	});
	return /* @__PURE__ */ import_react.createElement("line", _extends$29({ className: "recharts-polar-radius-axis-line" }, axisLineProps));
};
var renderTickItem = (option, tickProps, value) => {
	...
	else tickItem = /* @__PURE__ */ import_react.createElement(Text, _extends$29({}, tickProps, { className: "recharts-polar-radius-axis-tick-value" }), value);
	return tickItem;
};
var renderTicks = (props, ticks$1) => {
	var { angle, tickFormatter, stroke, tick } = props, others = _objectWithoutProperties$24(props, _excluded2$12);
...
function SetAngleAxisSettings(props) {
	...
	var settings = (0, import_react.useMemo)(() => {
		var { children } = props;
		return _objectWithoutProperties$23(props, _excluded$23);
	}, [props]);
...
var AxisLine$1 = (props) => {
	...
	var axisLineProps = _objectSpread$34(_objectSpread$34({}, svgPropertiesNoEvents(props)), {}, { fill: "none" }, filterProps(axisLine, false));
	if (axisLineType === "circle") return /* @__PURE__ */ import_react.createElement(Dot, _extends$28({ className: "recharts-polar-angle-axis-line" }, axisLineProps, {
		cx,
		cy,
		r: radius
	}));
	var points = ticks$1.map((entry) => polarToCartesian(cx, cy, radius, entry.coordinate));
	return /* @__PURE__ */ import_react.createElement(Polygon, _extends$28({ className: "recharts-polar-angle-axis-line" }, axisLineProps, { points }));
};
var TickItemText = (_ref$1) => {
	...
	return /* @__PURE__ */ import_react.createElement(Text, _extends$28({}, tickProps, { className: "recharts-polar-angle-axis-tick-value" }), value);
};
var Ticks$1 = (props) => {
	var { tick, tickLine, tickFormatter, stroke, ticks: ticks$1 } = props;
	var axisProps = svgPropertiesNoEvents(props);
	var customTickProps = filterProps(tick, false);
	var tickLineProps = _objectSpread$34(_objectSpread$34({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
	var items = ticks$1.map((entry, i) => {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$28({
			className: clsx("recharts-polar-angle-axis-tick", getTickClassName(tick)),
			key: "tick-".concat(entry.coordinate)
		}, adaptEventsOfChild(props, entry, i)), tickLine && /* @__PURE__ */ import_react.createElement("line", _extends$28({ className: "recharts-polar-angle-axis-tick-line" }, tickLineProps, lineCoord)), /* @__PURE__ */ import_react.createElement(TickItemText, {
			tick,
			tickProps,
...
var PolarAngleAxisWrapper = (defaultsAndInputs) => {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx("recharts-polar-angle-axis", AXIS_TYPE, props.className) }, /* @__PURE__ */ import_react.createElement(AxisLine$1, _extends$28({}, props, { ticks: ticks$1 })), /* @__PURE__ */ import_react.createElement(Ticks$1, _extends$28({}, props, { ticks: ticks$1 })));
};
...
var Trapezoid = (outsideProps) => {
	...
	if (!isUpdateAnimationActive) return /* @__PURE__ */ import_react.createElement("g", null, /* @__PURE__ */ import_react.createElement("path", _extends$27({}, filterProps(trapezoidProps, true), {
		className: layerClass,
	...
	return /* @__PURE__ */ import_react.createElement(JavascriptAnimate, {
		...
		return /* @__PURE__ */ import_react.createElement("path", _extends$27({}, filterProps(trapezoidProps, true), {
			className: layerClass,
...
function Shape(_ref2) {
	var { option, shapeType, propTransformer = defaultPropTransformer, activeClassName = "recharts-active-shape", isActive } = _ref2, props = _objectWithoutProperties$22(_ref2, _excluded$22);
	var shape;
...
var renderLabelLineItem = (option, props) => {
	...
	return /* @__PURE__ */ import_react.createElement(Curve, _extends$26({}, props, {
		type: "linear",
		className
	}));
};
var renderLabelItem = (option, props, value) => {
	...
	return /* @__PURE__ */ import_react.createElement(Text, _extends$26({}, props, {
...
function PieSectors(props) {
	...
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = allOtherPieProps, restOfAllOtherProps = _objectWithoutProperties$21(allOtherPieProps, _excluded$21);
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, sectors.map((entry, i) => {
		...
		}), /* @__PURE__ */ import_react.createElement(Shape, _extends$26({
	...
	return /* @__PURE__ */ import_react.createElement(PieLabelListProvider, {
		...
		sectors === null || sectors === void 0 || sectors.forEach((entry, index) => {
			...
			if (prev) {
				...
				var latest = _objectSpread$30(_objectSpread$30({}, entry), {}, {
...
function PieImpl(props) {
	var { id } = props, propsWithoutId = _objectWithoutProperties$21(props, _excluded2$11);
...
function Pie(outsideProps) {
	...
	var { id: externalId } = props, propsWithoutId = _objectWithoutProperties$21(props, _excluded3$8);
	...
	}), /* @__PURE__ */ import_react.createElement(SetPiePayloadLegend, _extends$26({}, propsWithoutId, { id })), /* @__PURE__ */ import_react.createElement(PieImpl, _extends$26({}, propsWithoutId, { id }))));
}
Pie.displayName = "Pie";
...
var cartesianAxisSlice = createSlice({
	...
	reducers: {
		...
		updateYAxisWidth(state, action) {
			...
			if (state.yAxis[id]) state.yAxis[id] = _objectSpread$29(_objectSpread$29({}, state.yAxis[id]), {}, { width });
		}
	}
});
...
function renderDotItem$2(option, props) {
	...
	else dotItem = /* @__PURE__ */ import_react.createElement(Dot, _extends$25({}, props, { className: clsx("recharts-radar-dot", typeof option !== "boolean" ? option.className : "") }));
	return dotItem;
}
...
function Dots$2(_ref2) {
	...
	if (!dot) return null;
	var { id } = props, propsWithoutId = _objectWithoutProperties$20(props, _excluded$20);
...
function StaticPolygon(_ref4) {
	...
	else radar = /* @__PURE__ */ import_react.createElement(Polygon, _extends$25({}, filterProps(props, true), {
...
function RadarImpl(props) {
	...
	return /* @__PURE__ */ import_react.createElement(RadarWithState, _extends$25({}, props, {
...
var Radar = class extends import_react.PureComponent {
	render() {
		return /* @__PURE__ */ import_react.createElement(RegisterGraphicalItemId, {
			...
			args: this.props
		}), /* @__PURE__ */ import_react.createElement(RadarImpl, _extends$25({}, this.props, { id }))));
	}
};
...
function typeguardBarRectangleProps(_ref$1, props) {
	var { x: xProp, y: yProp } = _ref$1, option = _objectWithoutProperties$19(_ref$1, _excluded$19);
...
function BarRectangle(props) {
	return /* @__PURE__ */ import_react.createElement(Shape, _extends$23({
		shapeType: "rectangle",
...
function SetErrorBarContext(props) {
	var { children } = props, rest = _objectWithoutProperties$18(props, _excluded$18);
...
function BarBackground(props) {
	...
	var { onMouseEnter: onMouseEnterFromProps, onMouseLeave: onMouseLeaveFromProps, onClick: onItemClickFromProps } = allOtherBarProps, restOfAllOtherProps = _objectWithoutProperties$17(allOtherBarProps, _excluded$17);
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, data.map((entry, i) => {
		var { value, background: backgroundFromDataEntry, tooltipPosition } = entry, rest = _objectWithoutProperties$17(entry, _excluded2$10);
		...
		return /* @__PURE__ */ import_react.createElement(BarRectangle, _extends$22({ key: "background-bar-".concat(barRectangleProps.index) }, barRectangleProps));
	}));
}
...
function BarRectangleWithActiveState(props) {
	...
	return /* @__PURE__ */ import_react.createElement(BarRectangle, _extends$22({}, baseProps, entry, {
		isActive,
		option,
		index,
		dataKey
...
function BarRectangles(_ref2) {
	...
	var _svgPropertiesNoEvent = svgPropertiesNoEvents(props), { id } = _svgPropertiesNoEvent, baseProps = _objectWithoutProperties$17(_svgPropertiesNoEvent, _excluded3$7);
	var { shape, dataKey, activeBar } = props;
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = props, restOfAllOtherProps = _objectWithoutProperties$17(props, _excluded4$3);
	var onMouseEnterFromContext = useMouseEnterItemDispatch(onMouseEnterFromProps, dataKey);
	var onMouseLeaveFromContext = useMouseLeaveItemDispatch(onMouseLeaveFromProps);
	var onClickFromContext = useMouseClickItemDispatch(onItemClickFromProps, dataKey);
	if (!data) return null;
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, data.map((entry, i) => {
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$22({ className: "recharts-bar-rectangle" }, adaptEventsOfChild(restOfAllOtherProps, entry, i), {
			onMouseEnter: onMouseEnterFromContext(entry, i),
			onMouseLeave: onMouseLeaveFromContext(entry, i),
			onClick: onClickFromContext(entry, i),
...
function BarImpl(props) {
	...
	return /* @__PURE__ */ import_react.createElement(SetErrorBarContext, {
		...
		errorBarOffset
	}, /* @__PURE__ */ import_react.createElement(BarWithState, _extends$22({}, props, {
		layout,
		needClip,
		data: rects,
		xAxisId,
...
function BarFn(outsideProps) {
	...
	return /* @__PURE__ */ import_react.createElement(RegisterGraphicalItemId, {
		...
		isPanorama
	}), /* @__PURE__ */ import_react.createElement(BarImpl, _extends$22({}, props, { id }))));
}
...
function RadialBarSectors(_ref2) {
	...
	var { shape, activeShape, cornerRadius, id } = allOtherRadialBarProps, others = _objectWithoutProperties$16(allOtherRadialBarProps, _excluded$16);
	var baseProps = svgPropertiesNoEvents(others);
	var activeIndex = useAppSelector(selectActiveTooltipIndex);
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = allOtherRadialBarProps, restOfAllOtherProps = _objectWithoutProperties$16(allOtherRadialBarProps, _excluded2$9);
	...
	return /* @__PURE__ */ import_react.createElement(RadialBarLabelListProvider, {
		...
		return /* @__PURE__ */ import_react.createElement(RadialBarSector, radialBarSectorProps);
...
var RadialBarWithState = class extends import_react.PureComponent {
	renderBackground(sectors) {
		...
		return sectors.map((entry, i) => {
			var { value, background } = entry, rest = _objectWithoutProperties$16(entry, _excluded3$6);
			...
			return /* @__PURE__ */ import_react.createElement(RadialBarSector, props);
		});
	}
	render() {
...
function RadialBarImpl(props) {
	...
	}), /* @__PURE__ */ import_react.createElement(RadialBarWithState, _extends$21({}, props, { data })));
}
...
var RadialBar = class extends import_react.PureComponent {
	render() {
		return /* @__PURE__ */ import_react.createElement(RegisterGraphicalItemId, {
			...
			}), /* @__PURE__ */ import_react.createElement(SetRadialBarPayloadLegend, this.props), /* @__PURE__ */ import_react.createElement(RadialBarImpl, _extends$21({}, this.props, { id })));
		});
	}
};
...
function BrushText(_ref4) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-brush-texts" }, /* @__PURE__ */ import_react.createElement(Text, _extends$20({
		textAnchor: "end",
		verticalAnchor: "middle",
		...
		dataKey,
		data
	})), /* @__PURE__ */ import_react.createElement(Text, _extends$20({
		textAnchor: "start",
		verticalAnchor: "middle",
...
function BrushInternal(props) {
	...
	return /* @__PURE__ */ import_react.createElement(BrushWithState, _extends$20({}, props, contextProperties, {
...
var renderLine = (option, props) => {
	...
	else line = /* @__PURE__ */ import_react.createElement("line", _extends$19({}, props, { className: "recharts-reference-line-line" }));
	return line;
};
...
function ReferenceLineImpl(props) {
	...
	var lineProps = _objectSpread$16(_objectSpread$16({ clipPath }, filterProps(props, true)), {}, {
		x1,
		y1,
		x2,
		y2
...
var renderDot = (option, props) => {
	...
	else dot = /* @__PURE__ */ import_react.createElement(Dot, _extends$18({}, props, {
		cx: props.cx,
		cy: props.cy,
...
function ReferenceDotImpl(props) {
	...
	var clipPath = ifOverflow === "hidden" ? "url(#".concat(clipPathId, ")") : void 0;
	var dotProps = _objectSpread$15(_objectSpread$15({ clipPath }, filterProps(props, true)), {}, {
		cx,
		cy
	});
...
function ReferenceDotSettingsDispatcher(props) {
	var { x: x$1, y: y$1, r, ifOverflow, yAxisId, xAxisId } = props;
...
var renderRect = (option, props) => {
	...
	else rect = /* @__PURE__ */ import_react.createElement(Rectangle, _extends$17({}, props, { className: "recharts-reference-area-rect" }));
	return rect;
};
...
function AxisLine(axisLineProps) {
	...
	if (!axisLine) return null;
	var props = _objectSpread$12(_objectSpread$12(_objectSpread$12({}, otherSvgProps), filterProps(axisLine, false)), {}, { fill: "none" });
	...
	return /* @__PURE__ */ import_react.createElement("line", _extends$16({}, props, { className: clsx("recharts-cartesian-axis-line", (0, import_get$3.default)(axisLine, "className")) }));
}
/**
...
function TickItem(props) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) tickItem = /* @__PURE__ */ import_react.cloneElement(option, _objectSpread$12(_objectSpread$12({}, tickProps), {}, { className: combinedClassName }));
		...
		tickItem = /* @__PURE__ */ import_react.createElement(Text, _extends$16({}, tickProps, { className }), value);
	}
	return tickItem;
}
function Ticks(props) {
	...
	var items = finalTicks.map((entry, i) => {
		...
		}, adaptEventsOfChild(events, entry, i)), tickLine && /* @__PURE__ */ import_react.createElement("line", _extends$16({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", (0, import_get$3.default)(tickLine, "className")) })), tick && /* @__PURE__ */ import_react.createElement(TickItem, {
			option: tick,
			tickProps,
...
var CartesianAxisComponent = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	var { axisLine, width, height, className, hide, ticks: ticks$1 } = props, rest = _objectWithoutProperties$15(props, _excluded$15);
	var [fontSize, setFontSize] = (0, import_react.useState)("");
	var [letterSpacing, setLetterSpacing] = (0, import_react.useState)("");
	var tickRefs = (0, import_react.useRef)([]);
...
var MemoCartesianAxis = /* @__PURE__ */ import_react.memo(CartesianAxisComponent, (prevProps, nextProps) => {
	var { viewBox: prevViewBox } = prevProps, prevRestProps = _objectWithoutProperties$15(prevProps, _excluded2$8);
	var { viewBox: nextViewBox } = nextProps, nextRestProps = _objectWithoutProperties$15(nextProps, _excluded3$5);
...
var CartesianAxis = /* @__PURE__ */ import_react.forwardRef((outsideProps, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement(MemoCartesianAxis, _extends$16({}, props, { ref }));
});
...
function renderLineItem(option, props) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) lineItem = /* @__PURE__ */ import_react.cloneElement(option, props);
		...
		var { x1, y1, x2, y2, key } = props, others = _objectWithoutProperties$14(props, _excluded$14);
		var _svgPropertiesNoEvent = svgPropertiesNoEvents(others), { offset: __ } = _svgPropertiesNoEvent, restOfFilteredProps = _objectWithoutProperties$14(_svgPropertiesNoEvent, _excluded2$7);
		lineItem = /* @__PURE__ */ import_react.createElement("line", _extends$15({}, restOfFilteredProps, {
			x1,
			y1,
			x2,
			y2,
...
function HorizontalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$14(props, _excluded3$4);
...
function VerticalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$14(props, _excluded4$2);
...
function CartesianGrid(props) {
	...
	}), /* @__PURE__ */ import_react.createElement(HorizontalStripes, _extends$15({}, propsIncludingDefaults, { horizontalPoints })), /* @__PURE__ */ import_react.createElement(VerticalStripes, _extends$15({}, propsIncludingDefaults, { verticalPoints })), /* @__PURE__ */ import_react.createElement(HorizontalGridLines, _extends$15({}, propsIncludingDefaults, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
	})), /* @__PURE__ */ import_react.createElement(VerticalGridLines, _extends$15({}, propsIncludingDefaults, {
		offset,
		verticalPoints,
		xAxis,
		yAxis
...
var _excluded$13 = ["id"], _excluded2$6 = [
	"type",
	"layout",
	"connectNulls",
	"needClip"
...
function Dots$1(_ref$1) {
	...
	var { id } = props, propsWithoutId = _objectWithoutProperties$13(props, _excluded$13);
...
function StaticCurve(_ref3) {
	...
	var { type, layout, connectNulls, needClip } = props, others = _objectWithoutProperties$13(props, _excluded2$6);
	var curveProps = _objectSpread$10(_objectSpread$10({}, filterProps(others, true)), {}, {
		fill: "none",
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ import_react.createElement(Curve, _extends$14({}, curveProps, { pathRef })), /* @__PURE__ */ import_react.createElement(Dots$1, {
		points,
		clipPathId,
		props
	}));
...
function LineImpl(props) {
	...
	return /* @__PURE__ */ import_react.createElement(LineWithState, _extends$14({}, everythingElse, {
		id,
		connectNulls,
		dot,
		activeDot,
...
function LineFn(outsideProps) {
	...
	return /* @__PURE__ */ import_react.createElement(RegisterGraphicalItemId, {
		...
		hide: props.hide,
		isPanorama
	}), /* @__PURE__ */ import_react.createElement(LineImpl, _extends$14({}, props, { id }))));
}
...
var _excluded$12 = ["id"], _excluded2$5 = [
	"activeDot",
	"animationBegin",
	"animationDuration",
	"animationEasing",
...
var renderDotItem = (option, props) => {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) dotItem = /* @__PURE__ */ import_react.cloneElement(option, props);
		...
		dotItem = /* @__PURE__ */ import_react.createElement(Dot, _extends$13({}, props, { className }));
	}
	return dotItem;
};
...
function Dots(_ref$1) {
	...
	var dotsProps = { clipPath: needClip ? "url(#clipPath-".concat(clipDot ? "" : "dots-").concat(clipPathId, ")") : void 0 };
	return /* @__PURE__ */ import_react.createElement(Layer, _extends$13({ className: "recharts-area-dots" }, dotsProps), dots);
}
...
function StaticArea(_ref3) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ import_react.createElement(Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0 }, /* @__PURE__ */ import_react.createElement(Curve, _extends$13({}, allOtherProps, {
		id,
		points,
		connectNulls,
		type,
	...
	})), stroke !== "none" && /* @__PURE__ */ import_react.createElement(Curve, _extends$13({}, allOtherProps, {
		...
		fill: "none",
		points
	})), stroke !== "none" && isRange && /* @__PURE__ */ import_react.createElement(Curve, _extends$13({}, allOtherProps, {
		className: "recharts-area-curve",
		layout,
		type,
		connectNulls,
...
function AreaImpl(props) {
	var _useAppSelector;
	var _resolveDefaultProps = resolveDefaultProps(props, defaultAreaProps), { activeDot, animationBegin, animationDuration, animationEasing, connectNulls, dot, fill, fillOpacity, hide, isAnimationActive, legendType, stroke, xAxisId, yAxisId } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$12(_resolveDefaultProps, _excluded2$5);
	var layout = useChartLayout();
	var chartName = useChartName();
	var { needClip } = useNeedsClip(xAxisId, yAxisId);
	var isPanorama = useIsPanorama();
	...
	var { height, width, x: left, y: top } = plotArea;
	if (!points || !points.length) return null;
	return /* @__PURE__ */ import_react.createElement(AreaWithState, _extends$13({}, everythingElse, {
		activeDot,
		animationBegin,
		animationDuration,
		animationEasing,
...
function AreaFn(outsideProps) {
	...
	}), /* @__PURE__ */ import_react.createElement(AreaImpl, _extends$13({}, props, { id }))));
}
...
function ScatterSymbol(_ref$1) {
	var { option, isActive } = _ref$1, props = _objectWithoutProperties$11(_ref$1, _excluded$11);
	if (typeof option === "string") return /* @__PURE__ */ import_react.createElement(Shape, _extends$12({
		option: /* @__PURE__ */ import_react.createElement(Symbols, _extends$12({ type: option }, props)),
		isActive,
		shapeType: "symbols"
	}, props));
...
function ScatterLine(_ref$1) {
	...
	else lineItem = /* @__PURE__ */ import_react.createElement(Curve, _extends$11({}, lineProps, { type: lineJointType }));
	return /* @__PURE__ */ import_react.createElement(Layer, {
...
function ScatterSymbols(props) {
	...
	var activeIndex = useAppSelector(selectActiveTooltipIndex);
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = allOtherScatterProps, restOfAllOtherProps = _objectWithoutProperties$10(allOtherScatterProps, _excluded$10);
	...
	if (points == null) return null;
	var { id } = allOtherScatterProps, allOtherPropsWithoutId = _objectWithoutProperties$10(allOtherScatterProps, _excluded2$4);
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(ScatterLine, {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$11({ className: "recharts-scatter-symbol" }, adaptEventsOfChild(restOfAllOtherProps, entry, i), {
			onMouseEnter: onMouseEnterFromContext(entry, i),
			onMouseLeave: onMouseLeaveFromContext(entry, i),
			onClick: onClickFromContext(entry, i),
			key: "symbol-".concat(entry === null || entry === void 0 ? void 0 : entry.cx, "-").concat(entry === null || entry === void 0 ? void 0 : entry.cy, "-").concat(entry === null || entry === void 0 ? void 0 : entry.size, "-").concat(i)
		}), /* @__PURE__ */ import_react.createElement(ScatterSymbol, _extends$11({
			option,
			isActive
		}, symbolProps)));
	}));
...
function ScatterImpl(props) {
	var _resolveDefaultProps = resolveDefaultProps(props, defaultScatterProps), { animationBegin, animationDuration, animationEasing, hide, isAnimationActive, legendType, lineJointType, lineType, shape, xAxisId, yAxisId, zAxisId } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$10(_resolveDefaultProps, _excluded3$2);
	var { needClip } = useNeedsClip(xAxisId, yAxisId);
	var cells = (0, import_react.useMemo)(() => findAllByType(props.children, Cell), [props.children]);
	var isPanorama = useIsPanorama();
	...
	}), /* @__PURE__ */ import_react.createElement(ScatterWithId, _extends$11({}, everythingElse, {
		xAxisId,
		yAxisId,
		zAxisId,
		lineType,
...
function ScatterFn(outsideProps) {
	...
	return /* @__PURE__ */ import_react.createElement(RegisterGraphicalItemId, {
		...
		isPanorama
	}), /* @__PURE__ */ import_react.createElement(ScatterImpl, _extends$11({}, props, { id }))));
}
...
var _excluded$9 = ["dangerouslySetInnerHTML", "ticks"], _excluded2$3 = ["id"], _excluded3$1 = ["domain"], _excluded4$1 = ["domain"];
...
var XAxisImpl = (props) => {
	...
	var { dangerouslySetInnerHTML, ticks: ticks$1 } = props, allOtherProps = _objectWithoutProperties$9(props, _excluded$9);
	var { id } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties$9(synchronizedSettings, _excluded2$3);
...
var XAxisMemoComparator = (prevProps, nextProps) => {
	var { domain: prevDomain } = prevProps, prevRest = _objectWithoutProperties$9(prevProps, _excluded3$1);
	var { domain: nextDomain } = nextProps, nextRest = _objectWithoutProperties$9(nextProps, _excluded4$1);
...
var _excluded$8 = ["dangerouslySetInnerHTML", "ticks"], _excluded2$2 = ["id"], _excluded3 = ["domain"], _excluded4 = ["domain"];
function _extends$9() {
...
var YAxisImpl = (props) => {
	...
	var { id } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties$8(synchronizedSettings, _excluded2$2);
	return /* @__PURE__ */ import_react.createElement(CartesianAxis, _extends$9({}, allOtherProps, restSynchronizedSettings, {
...
var YAxisMemoComparator = (prevProps, nextProps) => {
	var { domain: prevDomain } = prevProps, prevRest = _objectWithoutProperties$8(prevProps, _excluded3);
	var { domain: nextDomain } = nextProps, nextRest = _objectWithoutProperties$8(nextProps, _excluded4);
	if (!shallowEqual(prevRest, nextRest)) return false;
	if (Array.isArray(prevDomain) && prevDomain.length === 2 && Array.isArray(nextDomain) && nextDomain.length === 2) return prevDomain[0] === nextDomain[0] && prevDomain[1] === nextDomain[1];
	return shallowEqual({ domain: prevDomain }, { domain: nextDomain });
};
...
function ErrorBarImpl(props) {
	var { direction, width, dataKey, isAnimationActive, animationBegin, animationDuration, animationEasing } = props, others = _objectWithoutProperties$7(props, _excluded$7);
	...
	var errorBars = data.map((entry) => {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$8({
			...
			}, (style) => /* @__PURE__ */ import_react.createElement("line", _extends$8({}, coordinates, { style: _objectSpread$7(_objectSpread$7({}, lineStyle), style) })));
		}));
	});
...
function ErrorBarInternal(props) {
	...
	}), /* @__PURE__ */ import_react.createElement(ErrorBarImpl, _extends$8({}, props, {
		direction: realDirection,
		width,
		isAnimationActive,
		animationBegin,
...
var MainChartSurface = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement(Surface, _extends$7({}, otherAttributes, {
		title,
		desc,
		role,
		tabIndex,
...
var RootSurface = /* @__PURE__ */ (0, import_react.forwardRef)((_ref2, ref) => {
	var { children } = _ref2, rest = _objectWithoutProperties$6(_ref2, _excluded$6);
	if (useIsPanorama()) return /* @__PURE__ */ import_react.createElement(BrushPanoramaSurface, null, children);
	return /* @__PURE__ */ import_react.createElement(MainChartSurface, _extends$7({ ref }, rest), children);
});
...
var RechartsWrapper = /* @__PURE__ */ (0, import_react.forwardRef)((_ref$1, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement(TooltipPortalContext.Provider, { value: tooltipPortal }, /* @__PURE__ */ import_react.createElement(LegendPortalContext.Provider, { value: legendPortal }, /* @__PURE__ */ import_react.createElement("div", {
...
var CategoricalChart = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	var { children, className, width, height, style, compact, title, desc } = props, others = _objectWithoutProperties$5(props, _excluded$5);
	var attrs = svgPropertiesNoEvents(others);
	if (compact) return /* @__PURE__ */ import_react.createElement(RootSurface, {
...
var CartesianChart = /* @__PURE__ */ (0, import_react.forwardRef)(function CartesianChart$1(props, ref) {
	...
	var { width, height } = rootChartProps, otherCategoricalProps = _objectWithoutProperties$4(rootChartProps, _excluded$4);
	if (!isPositiveNumber(width) || !isPositiveNumber(height)) return null;
	...
	}), /* @__PURE__ */ import_react.createElement(CategoricalChart, _extends$6({}, otherCategoricalProps, {
		width,
		height,
		ref
	})));
...
var PolarChart = /* @__PURE__ */ (0, import_react.forwardRef)(function PolarChart$1(props, ref) {
	...
	var { width, height, layout } = polarChartProps, otherCategoricalProps = _objectWithoutProperties$3(polarChartProps, _excluded$3);
	if (!isPositiveNumber(width) || !isPositiveNumber(height)) return null;
	...
	}), /* @__PURE__ */ import_react.createElement(CategoricalChart, _extends$5({
		width,
		height
	}, otherCategoricalProps, { ref })));
});
...
var computeNode = (_ref$1) => {
	...
	var nodeValue;
	if (children && children.length) nodeValue = computedChildren.reduce((result, child) => result + child[NODE_VALUE_KEY], 0);
...
var TreemapWithState = class extends import_react.PureComponent {
	...
	renderItem(content, nodeProps, isLeaf) {
		...
		var { width, height, x: x$1, y: y$1, depth } = nodeProps;
		...
		if (!isAnimationActive) return /* @__PURE__ */ import_react.createElement(Layer, event, /* @__PURE__ */ import_react.createElement(ContentItemWithEvents, {
			content,
			dataKey,
		...
		}, (style) => /* @__PURE__ */ import_react.createElement(Layer, _extends$4({}, event, { style }), depth > 2 && !isAnimationFinished ? null : /* @__PURE__ */ import_react.createElement(ContentItemWithEvents, {
			content,
			dataKey,
			nodeProps: _objectSpread$5(_objectSpread$5({}, nodeProps), {}, {
				isAnimationActive,
	...
	renderNode(root, node) {
		...
		if (!(currentRoot.children || []).filter((item) => item.depth === node.depth && item.name === node.name).length && root.depth && type === "nest") return null;
		return /* @__PURE__ */ import_react.createElement(Layer, {
	...
	render() {
		...
		var attrs = svgPropertiesNoEvents(others);
		return /* @__PURE__ */ import_react.createElement(TooltipPortalContext.Provider, { value: this.state.tooltipPortal }, /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
			...
			height,
			ref: (node) => {
				if (this.state.tooltipPortal == null) this.setState({ tooltipPortal: node });
			},
			onMouseEnter: void 0,
			onMouseLeave: void 0,
			onClick: void 0,
...
function TreemapDispatchInject(props) {
	var dispatch = useAppDispatch();
	return /* @__PURE__ */ import_react.createElement(TreemapWithState, _extends$4({}, props, { dispatch }));
}
function Treemap(props) {
	...
	return /* @__PURE__ */ import_react.createElement(RechartsStoreProvider, {
		...
		width,
		height
	}), /* @__PURE__ */ import_react.createElement(ReportChartMargin, { margin: defaultTreemapMargin }), /* @__PURE__ */ import_react.createElement(TreemapDispatchInject, props));
}
...
var getNodesTree = (_ref$1, width, nodeWidth) => {
	...
	var maxDepth = (0, import_maxBy.default)(tree, (entry) => entry.depth).depth;
	if (maxDepth >= 1) {
...
var computeData = (_ref2) => {
	...
	for (var i = 1; i <= iterations; i++) {
		relaxRightToLeft(tree, depthTree, newLinks, alpha$1 *= .99);
		resolveCollisions(depthTree, height, nodePadding, sort);
		relaxLeftToRight(tree, depthTree, newLinks, alpha$1);
		resolveCollisions(depthTree, height, nodePadding, sort);
	}
...
var buildNodeProps = (_ref6) => {
	...
	return _objectSpread$4(_objectSpread$4({}, filterProps(nodeContent, false)), {}, {
		x: x$1 + left,
		y: y$1 + top,
		width: dx,
		height: dy,
...
var Sankey = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
	...
	static getDerivedStateFromProps(nextProps, prevState) {
		...
		if (data !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || !shallowEqual(margin, prevState.prevMargin) || iterations !== prevState.prevIterations || nodeWidth !== prevState.prevNodeWidth || nodePadding !== prevState.prevNodePadding || sort !== prevState.sort) {
			...
			var top = (0, import_get$1.default)(margin, "top") || 0;
			var left = (0, import_get$1.default)(margin, "left") || 0;
	...
	render() {
		var _this$props = this.props, { width, height, className, style, children } = _this$props, others = _objectWithoutProperties$1(_this$props, _excluded2$1);
		if (!isPositiveNumber(width) || !isPositiveNumber(height)) return null;
		...
		return /* @__PURE__ */ import_react.createElement(RechartsStoreProvider, {
			...
			args: this.props
		}), /* @__PURE__ */ import_react.createElement(SetComputedData, { computedData: {
			links: modifiedLinks,
			nodes: modifiedNodes
		} }), /* @__PURE__ */ import_react.createElement(ReportChartSize, {
			width,
			height
		}), /* @__PURE__ */ import_react.createElement(ReportChartMargin, { margin: defaultSankeyMargin }), /* @__PURE__ */ import_react.createElement(TooltipPortalContext.Provider, { value: this.state.tooltipPortal }, /* @__PURE__ */ import_react.createElement(RechartsWrapper, {
			className,
			style,
			width,
			height,
...
function FunnelTrapezoids(props) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, trapezoids.map((entry, i) => {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, _extends({ className: "recharts-funnel-trapezoid" }, adaptEventsOfChild(restOfAllOtherProps, entry, i), {
			onMouseEnter: onMouseEnterFromContext(entry, i),
			onMouseLeave: onMouseLeaveFromContext(entry, i),
			onClick: onClickFromContext(entry, i),
